...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Título:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"Coloque o título\" value=\"" +
    ...
    "\"></div><div><label for=\"preco\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"Descreva o livro.\">" +
